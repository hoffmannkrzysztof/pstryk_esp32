...
// full real field set to prove the parser ignores the extras. The live API does
// not emit `is_live` at all -- the current frame is derived from the clock.
static const char* kPricingJson = R"JSON(
{
  "frames": [
    {"start":"2026-06-02T06:00:00Z","end":"2026-06-02T07:00:00Z","metrics":{"pricing":{"tge_price":0.20,"dist_price":0.0827,"service_price":0.08,"base_price":0.25,"vat_component":0.05,"excise_component":0.005,"full_price":0.30,"price_net":0.24,"price_gross":0.30,"price_prosumer_net":0.15,"price_prosumer_gross":0.18,"is_cheap":true,"is_expensive":false}}},
